...
public class FlightMasterImplementationTest {
	...
	public void testFlight(){
		...
		/*LocationMaster locationMaster1=(LocationMaster) factory.getCurrentSession().get(LocationMaster.class, 8005); 
		LocationMaster locationMaster2=(LocationMaster) factory.getCurrentSession().get(LocationMaster.class, 8002);
